...
pygame.mixer.music.load("C:\\Users\\Lenovo\\Downloads\\wav\\Billie Eilish - Bored (online-audio-converter.com).wav")
...
f = wave.open("C:\\Users\\Lenovo\\Downloads\\wav\\Billie Eilish - Bored (online-audio-converter.com).wav", 'rb')
params = f.getparams()
